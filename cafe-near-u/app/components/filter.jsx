...
import { Card, Checkbox, Button, ButtonGroup } from "@material-tailwind/react";
                    ...
                    <div className="flex items-center mb-2">
                        ...
                        <div className="relative w-36">
                            ...
                            <input
                                ...
                                placeholder="最高限制金額"
                                onChange={(e) =>
                                    setmoney("&min_order=" + e.target.value)
                                }
                            />
                        </div>
                    </div>
