                ...
                <div className="flex items-end gap-8 mt-4 flex-nowrap overflow-scroll ">
                    <div className="flex flex-col">
                        <IconButton
                            ...
                            onClick={() => {
                                router.push("/searchresult/type=工作");
                            }}
                        >
                    ...
                    <div className="flex flex-col">
                        <IconButton
                            ...
                            className="rounded-full"
                            onClick={() => {
                                router.push("/searchresult/type=休閒");
                            }}
                        >
                            <span className="material-symbols-outlined">
                                local_cafe
                    ...
                    <div className="flex flex-col">
                        <IconButton
                            ...
                            className="rounded-full"
                            onClick={() => {
                                router.push("/searchresult/type=寵物");
                            }}
                        >
                    ...
                    <div className="flex flex-col">
                        <IconButton
                            ...
                            className="rounded-full"
                            onClick={() => {
                                router.push("/searchresult/no_time_limit=true");
                            }}
                        >
                            <span className="material-symbols-outlined">
                                schedule
                    ...
                    <div className="flex flex-col">
                        <IconButton
                            ...
                            className="rounded-full"
                            onClick={() => {
                                router.push("/searchresult/plug=true");
                            }}
                        >
                            <span className="material-symbols-outlined">
                                power
                ...
                <div className="container mx-auto grid grid-cols-12 gap-8 mt-8">
                    ...
                    <div className="col-span-12 grid grid-cols-12 gap-8">
                        {homepage.workspace?.map((store) => (
                            <StoreCard
                                className={
                                    "rounded-xl col-span-6 lg:col-span-3"
                                }
                                key={store.id}
                                store={store}
                            />
